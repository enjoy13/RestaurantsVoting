...
import ua.enjoy.graduation.util.exception.ErrorInfo;
import ua.enjoy.graduation.util.exception.IllegalRequestDataException;
...
public class ExceptionInfoHandler {
    ...
    @ExceptionHandler(VotingSaveExceptions.class)
    @ResponseBody
    public ErrorInfo votingTimeViolation(HttpServletRequest req, VotingSaveExceptions e) {
        return new ErrorInfo(req.getRequestURL(), e.getLocalizedMessage());
    }
